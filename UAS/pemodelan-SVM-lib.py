...
def main():
    ...
    # 5. Inisialisasi dan pelatihan SVM (library)
    print("Melatih SVM (scikit-learn) pada data hasil SMOTE...")
    svm_clf = SVC(kernel='rbf', probability=True, random_state=42)
    svm_clf.fit(X_train_scaled, y_train_smote)

    # 6. Prediksi dan evaluasi
    y_pred = svm_clf.predict(X_test_scaled)

    print("\n--- EVALUASI SVM (LIBRARY) ---")
